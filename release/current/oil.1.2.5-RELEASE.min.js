...
!function(e) {
    ...
    r.e = function(e) {
        ...
        if (0 !== n)
            if (n)
                ...
                s.src = function(e) {
                    return r.p + "" + e + ".1.2.5-RELEASE.chunk.js"
                }(e);
    ...
    ,
    r.p = "https://unpkg.com/@ideasio/oil.js@1.2.5/release/current/",
    r.oe = function(e) {
...
, function(e, t, n) {
    ...
    t.sendEventToHostSite = function(e) {
        ...
        (0,
        o.logInfo)("Sent postmessage event: " + e)
    }
    ,
    ...
    t.setGlobalOilObject = function(e, t) {
        window[r.OIL_GLOBAL_OBJECT_NAME] || (window[r.OIL_GLOBAL_OBJECT_NAME] = {}),
    ...
    t.fetchJsonData = function(e) {
        return new Promise(function(t, n) {
            ...
            (0,
            o.logInfo)("Fetching data from url: " + e),
            r.open("GET", e),
                ...
                if (r.readyState === this.DONE)
                    if (200 === r.status)
                        ...
                        if (0 !== r.status) {
                            ...
                            o = new Error("Connection error occurred while fetching JSON data from " + e + "!");
                        n(o)
                    }
            }
            ,
    ...
    var s = window.addEventListener ? "addEventListener" : "attachEvent"
      , u = window.removeEventListener ? "removeEventListener" : "removeEvent"
      , c = window[s]
      , l = window[u]
      , f = "attachEvent" === s ? "onmessage" : "message"
...
, function(e, t, n) {
    ...
    t.logError = function() {
        ((0,
        o.isDev)() || (0,
        r.isVerboseCookieSet)()) && window.console && s(window.console.error, arguments)
    }
    ,
    t.logInfo = function() {
        ((0,
        o.isDev)() || (0,
        r.isVerboseCookieSet)()) && window.console && s(window.console.info, arguments)
    }
    ,
    t.logWarn = function() {
        ((0,
        o.isDev)() || (0,
        r.isVerboseCookieSet)()) && window.console && s(window.console.warn, arguments)
    }
    ,
    t.logPreviewInfo = function() {
        ...
        o.isDev)() || (0,
        i.isPreviewMode)() || (0,
        r.isPreviewCookieSet)() || (0,
        r.isVerboseCookieSet)()) && s(window.console.info, arguments)
    }
    ;
    var o = n(2)
      , r = n(16)
...
, function(e, t, n) {
    ...
    ,
    t.isSubscriberSetCookieActive = function() {
        return u(o.OIL_CONFIG.ATTR_SUB_SET_COOKIE, !0)
    }
    ,
    t.getHubOrigin = c,
    t.getHubPath = l,
    ...
    ,
    t.getLocaleVariantName = d,
    t.getLanguage = function() {
        return p(d())
    }
    ,
    t.getLanguageFromLocale = p,
    ...
    t.resetConfiguration = function() {
        (0,
        i.setGlobalOilObject)("CONFIG", null)
    }
    ,
    t.getCustomPurposes = v,
    ...
    function a() {
        if (!(0,
        i.getGlobalOilObject)("CONFIG")) {
            var e = document.querySelector('script[type="application/configuration"]#oil-configuration');
            null === e && (0,
            r.logInfo)("Using default config"),
            (0,
            i.setGlobalOilObject)("CONFIG", function(e) {
                var t = {};
                try {
                    e && e.text && (t = JSON.parse(e.text),
                    (0,
                    r.logInfo)("Parsed config", t))
                } catch (e) {
                    (0,
                    r.logError)("Error config", e)
                }
                return t
            }(e)),
            (0,
            i.setGlobalOilObject)("CONFIG_ATTRIBUTES", o.OIL_CONFIG),
            (n = g()) && "string" != typeof n || void 0 !== f() || ((0,
            r.logError)("Incorrect or missing locale parameter found. Please review documentation on how to set the locale object in your configuration."),
            a = "https://oil-backend.herokuapp.com/oil/api/userViewLocales/" + d(),
            s(o.OIL_CONFIG.ATTR_LOCALE_URL, a)),
            u(o.OIL_CONFIG.ATTR_CONFIG_VERSION, void 0) || (0,
            r.logError)('Your configuration is faulty - it must contain a "config_version" property. See the oil.js documentation for details.'),
            (t = g()) && (0,
            i.isObject)(t) && (t.localeId || (0,
            r.logError)('Your configuration is faulty - "locale" object misses "localeId" property. See the oil.js documentation for details.'),
            t.version || (0,
            r.logError)('Your configuration is faulty - "locale" object misses "version" property. See the oil.js documentation for details.'))
        }
        var t, n, a;
        return (0,
        i.getGlobalOilObject)("CONFIG")
    ...
    function c() {
        ...
        return e ? -1 !== e.indexOf("http") ? e : location.protocol + e : null
    }
    function l() {
    ...
    function d() {
        ...
        return e || (e = "enEN_01"),
        e && (0,
        i.isObject)(e) ? e.localeId ? e.localeId : "enEN_01" : e
    }
    function p() {
...
, function(e, t, n) {
    var o = n(1)
      ...
      , s = n(24)
      , u = function(e, t, n) {
        var c, l, f, d, p = e & u.F, v = e & u.G, g = e & u.S, _ = e & u.P, h = e & u.B, m = v ? o : g ? o[t] || (o[t] = {}) : (o[t] || {}).prototype, O = v ? r : r[t] || (r[t] = {}), y = O.prototype || (O.prototype = {});
        for (c in v && (n = t),
        n)
            f = ((l = !p && m && void 0 !== m[c]) ? m : n)[c],
            d = h && l ? s(f, o) : _ && "function" == typeof f ? s(Function.call, f) : f,
            m && a(m, c, f, e & u.U),
            O[c] != f && i(O, c, d),
            _ && y[c] != f && (y[c] = f)
    };
...
, function(e, t, n) {
    ...
    ;
    t.setSessionCookie = h,
    t.setDomainCookie = m,
    t.getOilCookie = O,
    t.hasOutdatedOilCookie = y,
    t.findCookieConsideringCookieVersions = I,
    t.getSoiCookie = function() {
        var e = I(E(), P);
        return (0,
        a.logInfo)("Current Oil data from domain cookie: ", e),
        e
    }
    ,
    t.setSoiCookieWithPoiCookieData = function(e) {
        return new Promise(function(t, n) {
            (0,
            l.loadVendorList)().then(function() {
                var n = E()
                  , o = void 0
                ...
                if (e.consentString)
                    ...
                    i.setPurposesAllowed(e.consentData.allowedPurposeIds),
                    i.setVendorsAllowed(e.consentData.allowedVendorIds),
                    i.setConsentLanguage(e.consentData.consentLanguage),
    ...
    t.isVerboseCookieSet = function() {
        return "true" === i.default.get(v)
    }
    ,
    t.removeSubscriberCookies = w,
    t.removeHubCookie = function(e) {
        w(),
        e && i.default.remove(e + "_" + g)
    }
    ,
    t.isBrowserCookieEnabled = function() {
        i.default.set("oil_cookie_exp", "cookiedata");
        var e = S("oil_cookie_exp");
        return i.default.remove("oil_cookie_exp"),
        e
    }
    ,
    t.getStandardPurposesWithConsent = A,
    t.getCustomPurposesWithConsent = T;
    var r, i = (r = n(38)) && r.__esModule ? r : {
        default: r
    }, a = n(5), s = n(6), u = n(2), c = n(13), l = n(29), f = n(2), d = n(56).ConsentString, p = "oil_preview", v = "oil_verbose", g = "oil_data", _ = "oil_data_session";
    function h(e, t) {
        i.default.set(e, t)
    }
    function m(e, t, n) {
    ...
    function O(e) {
        ...
        return t.consentData = new d(t.consentString),
        t
    }
    function y(e) {
    ...
    function I(e, t) {
        ...
        return function(e) {
            ...
            return t.splice(t.indexOf("configVersion"), 1),
            C(e.name, t)
        }(e) ? (n = O(e)).configVersion = c.OIL_CONFIG_DEFAULT_VERSION : n = y(e) ? t(e) : e.defaultCookieContent,
        n
    }
    function b(e) {
        return new Promise(function(t, n) {
            ...
            l.loadVendorList)().then(function() {
                ...
                o.setGlobalVendorList((0,
                l.getVendorList)()),
                o.setPurposesAllowed(A(e)),
                o.setVendorsAllowed((0,
                l.getLimitedVendorIds)()),
                t({
                    opt_in: !0,
                    version: n.defaultCookieContent.version,
                    localeVariantName: n.defaultCookieContent.localeVariantName,
                    localeVariantVersion: n.defaultCookieContent.localeVariantVersion,
                    customPurposes: T(e),
                    consentString: o.getConsentString(),
    ...
    function A(e) {
        return "object" === (void 0 === e ? "undefined" : o(e)) ? (0,
        l.getPurposes)().map(function(e) {
            return e.id
        }).filter(function(t) {
            return e[t]
        }) : 1 === e ? (0,
    ...
    function T(e, t) {
        return t || (t = (0,
        s.getCustomPurposes)()),
        "object" === (void 0 === e ? "undefined" : o(e)) ? t.map(function(e) {
            return e.id
        }).filter(function(t) {
            return e[t]
    ...
    function C(e, t) {
        return function(e, t) {
            if ("string" == typeof e && Array.isArray(t) && S(e)) {
    ...
    function E() {
        var e = new d;
        return e.setCmpId(c.OIL_SPEC.CMP_ID),
        e.setCmpVersion(c.OIL_SPEC.CMP_VERSION),
        e.setConsentScreen(1),
        e.setConsentLanguage((0,
        s.getLanguage)()),
        e.setPurposesAllowed((0,
        s.getDefaultToOptin)() ? (0,
        l.getPurposes)().map(function(e) {
            return e.id
        }) : []),
        e.setVendorsAllowed((0,
        s.getDefaultToOptin)() ? (0,
        l.getLimitedVendorIds)() : []),
        e.setGlobalVendorList((0,
        l.getVendorList)()),
        {
            name: g,
            expires: (0,
            ...
            defaultCookieContent: {
                opt_in: !1,
                version: f.OilVersion.get(),
                localeVariantName: (0,
                s.getLocaleVariantName)(),
                localeVariantVersion: (0,
                u.getLocaleVariantVersion)(),
                customPurposes: T((0,
                s.getDefaultToOptin)() ? 1 : 0),
                consentData: e,
                consentString: e.getConsentString(),
                configVersion: (0,
                s.getConfigVersion)()
            },
    ...
    function P(e) {
        ...
        n.customPurposes = T(t.privacy),
        n.consentData.setConsentLanguage((0,
        s.getLanguageFromLocale)(t.localeVariantName)),
        n.consentData.setPurposesAllowed(A(t.privacy)),
        n.consentData.setVendorsAllowed((0,
        l.getLimitedVendorIds)()),
        n.consentData.setGlobalVendorList((0,
        l.getVendorList)()),
        n.consentString = n.consentData.getConsentString(),
        n
    }
}
, function(e, t) {
...
, function(e, t, n) {
    ...
    (e.exports = function(e, t, n, s) {
        ...
        e[t] !== n && (c && (i(n, a) || r(n, a, e[t] ? "" + e[t] : u.join(String(t)))),
...
, function(e, t, n) {
    ...
    t.pendingVendorlistPromise = t.cachedVendorList = t.DEFAULT_VENDOR_LIST = void 0,
    t.loadVendorList = function() {
        return new Promise(function(e) {
            if (s)
                ...
                var n = (0,
                o.getIabVendorListUrl)();
                t.pendingVendorlistPromise = u = (0,
                i.fetchJsonData)(n),
                u.then(function(n) {
                    var o;
                    t.cachedVendorList = s = n,
                    t.pendingVendorlistPromise = u = null,
                    (o = s).vendors = o.vendors.sort(function(e, t) {
                        return e.id - t.id
                    }),
                    e(s)
                }).catch(function(n) {
                    t.pendingVendorlistPromise = u = null,
                    (0,
                    r.logError)("OIL getVendorList failed and returned error: " + n + ". Falling back to default vendor list!"),
                    e(d())
                })
            }
        }
    ...
    t.getVendors = l,
    t.getVendorIds = f,
    t.getVendorListVersion = function() {
        return s ? s.vendorListVersion : a.vendorListVersion
    }
    ,
    t.getVendorList = d,
    t.clearVendorListCache = function() {
        t.cachedVendorList = s = void 0,
        t.pendingVendorlistPromise = u = null
    }
    ,
    t.getVendorsToDisplay = function() {
        return (0,
        o.getShowLimitedVendors)() ? p() : l()
    }
    ,
    t.getLimitedVendors = p,
    t.getLimitedVendorIds = v;
    var o = n(6)
      , r = n(5)
      , i = n(2)
      ...
      , s = t.cachedVendorList = void 0
      , u = t.pendingVendorlistPromise = null;
    function c() {
        return s ? s.purposes : _(a.purposeIds)
    }
    function l() {
        return s ? s.vendors : _(g())
    }
    function f() {
    ...
    function v() {
        ...
        e = s ? f() : g();
        var t = (0,
        o.getIabVendorWhitelist)()
          , n = (0,
        o.getIabVendorBlacklist)();
...
, function(e, t, n) {
    var o, r, i, a = n(24), s = n(89), u = n(46), c = n(30), l = n(1), f = l.process, d = l.setImmediate, p = l.clearImmediate, v = l.MessageChannel, g = l.Dispatch, _ = 0, h = {}, m = function() {
        var e = +this;
    ...
    : v ? (i = (r = new v).port2,
    r.port1.onmessage = O,
    o = a(i.postMessage, i, 1)) : l.addEventListener && "function" == typeof postMessage && !l.importScripts ? (o = function(e) {
        l.postMessage(e + "", "*")
    }
    ,
...
, function(e, t, n) {
    "use strict";
    var o, r, i, a, s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        return typeof e
    }
    : function(e) {
        return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    ...
    ,
    function(e) {
        var t, n, r, u = this, c = arguments.length > 1 ? arguments[1] : void 0;
        if (void 0 !== c) {
            if (!o(c))
        ...
        var l = function(e, t) {
            ...
            if (null != e) {
                if (["string", "number", "boolean", "symbol"].indexOf(void 0 === e ? "undefined" : s(e)) > -1)
        ...
        if (void 0 !== l) {
            ...
            var g, _ = i(v.length);
            for (n = o(u) ? Object(new u(_)) : new Array(_),
            r = 0; r < _; )
                g = v[r],
                n[r] = c ? c.call(t, g, r) : g,
                r++;
            n.length = _
        }
        return n
    ...
    var f = n(53)
      ...
      , p = f.padRight;
    function v(e) {
        for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new Set, n = Math.max.apply(Math, [0].concat(l(e.map(function(e) {
            return e.id
        })), l(c(t)))), o = "", r = 1; r <= n; r += 1)
            o += -1 !== t.indexOf(r) ? "1" : "0";
        return o
    ...
    function g(e, t) {
        ...
        return e.reduce(function(r, i, a) {
            ...
            (-1 === t.indexOf(s) || a === e.length - 1 || -1 === o.indexOf(s + 1)) && n.length) {
                var u = n.shift()
                  , c = n.pop();
                return n = [],
                [].concat(l(r), [{
    ...
    e.exports = {
        ...
        encodeConsentString: function(e) {
            ...
            var f = d(u({}, e, {
                maxVendorId: t,
                purposeIdBitString: v(l, r),
                isRange: !1,
                vendorIdBitString: function(e) {
                    for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], n = "", o = 1; o <= e; o += 1)
                        n += -1 !== t.indexOf(o) ? "1" : "0";
...
, function(e, t, n) {
    ...
    ), c = n(98), l = n(54), f = l.versionNumBits, d = l.vendorVersionMap;
    function p(e) {
    ...
    function v(e, t) {
        return p(Math.max(0, t)) + e
    }
    function g(e, t) {
        return e + p(Math.max(0, t))
    }
    function _(e, t) {
        var n = "";
        return "number" != typeof e || isNaN(e) || (n = parseInt(e, 10).toString(2)),
        t >= n.length && (n = v(n, t - n.length)),
    ...
    function m(e, t) {
        return e instanceof Date ? _(e.getTime() / 100, t) : _(e, t)
    }
    function O(e, t) {
        return _(e.toUpperCase().charCodeAt(0) - 65, t)
    }
    function y(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 12;
        return O(e.slice(0, 1), t / 2) + O(e.slice(1), t / 2)
    }
    function I(e, t, n) {
        return parseInt(e.substr(t, n), 2)
    }
    function b(e, t, n) {
        return new Date(100 * I(e, t, n))
    }
    function w(e, t) {
    ...
    function S(e) {
        ...
        case "date":
            return m(l, u);
        case "bits":
            return g(l, u - l.length).substring(0, u);
        case "list":
    ...
    e.exports = {
        ...
        encodeBoolToBits: h,
        encodeDateToBits: m,
        encodeLanguageToBits: y,
        encodeLetterToBits: O,
        encodeToBase64: function(e) {
            var t = E(e, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d);
            if (t) {
                for (var n = g(t, 7 - (t.length + 7) % 8), o = "", r = 0; r < n.length; r += 8)
                    o += String.fromCharCode(parseInt(n.substr(r, 8), 2));
                return c.encode(o).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "")
            }
            return null
        },
                            ...
                            var r = o.name
                              ...
                              , s = function(t) {
                                ...
                                var d = "function" == typeof s ? s(o) : s
                                  , p = 0;
                                switch ("function" == typeof f ? p = f(o) : "number" == typeof f && (p = f),
                                a) {
                                case "int":
                                    return {
                                        fieldValue: I(n, r, d)
                                ...
                                case "bits":
                                    return {
                                        fieldValue: n.substr(r, d)
                                    };
                                case "list":
                                    return new Array(p).fill().reduce(function(t) {
                                        var o = e({
                                            input: n,
                                            fields: i.fields,
                                            startPosition: t.newPosition
                                        })
                                          , r = o.decodedObject
                                          , a = o.newPosition;
                                        return {
                              ...
                              , c = s.fieldValue
                              , l = s.newPosition;
                            return void 0 !== c && (t[r] = c),
                            void 0 !== l ? i = l : "number" == typeof a && (i += a),
                            t
                        }, {}),
                        newPosition: i
                    }
...
, function(e, t, n) {
    "use strict";
    "function" == typeof Symbol && Symbol.iterator;
    var o = (Array.from || Math.pow(2, 53),
    n(53))
      , r = o.decodeBitsToIds
        ...
        decodeConsentString: function(e) {
            ...
            if (f) {
                var O = v.reduce(function(e, t) {
                    for (var n = t.isRange, o = t.startVendorId, r = t.endVendorId, i = n ? r : o, a = o; a <= i; a += 1)
                        e[a] = !0;
                    return e
                }, {});
                m.allowedVendorIds = [];
                for (var y = 0; y <= u; y += 1)
                    (d && !O[y] || !d && O[y]) && -1 === m.allowedVendorIds.indexOf(y) && m.allowedVendorIds.push(y)
            } else
                m.allowedVendorIds = r(p);
            return m
        }
    }
}
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        return function(t) {
            for (var n, a = r(t), s = o(a), u = s.length, c = 0, l = []; u > c; )
...
, function(e, t, n) {
    ...
    var o = n(36)
      ...
      , i = n(26);
    e.exports = function(e) {
        for (var t = o(this), n = i(t.length), a = arguments.length, s = r(a > 1 ? arguments[1] : void 0, n), u = a > 2 ? arguments[2] : void 0, c = void 0 === u ? n : r(u, n); c > s; )
            t[s++] = e;
        return t
    }
}
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n, v, g, _, h) {
        ...
        }, b = t + " Iterator", w = "values" == g, A = !1, T = e.prototype, S = T[f] || T["@@iterator"] || g && T[g], C = S || I(g), E = g ? w ? I("entries") : C : void 0, P = "Array" == t && T.entries || S;
        if (P && (y = l(P.call(new e))) !== Object.prototype && y.next && (c(y, b, !0),
        o || "function" == typeof y[f] || a(y, f, p)),
        w && S && "values" !== S.name && (A = !0,
        C = function() {
            return S.call(this)
        }
        ),
...
, function(e, t, n) {
    ...
    e.exports = !u || n(17)(function() {
        ...
        for (var n = a(e), u = arguments.length, c = 1, l = r.f, f = i.f; u > c; )
            for (var d, p = s(arguments[c++]), v = l ? o(p).concat(l(p)) : o(p), g = v.length, _ = 0; g > _; )
...
, function(e, t, n) {
    ...
    : function(e) {
      ...
      , K = function(e, t, n) {
        ...
        t = I(t, !0),
        m(n),
        r(M, t) ? (n.enumerable ? (r(e, x) && e[x][t] && (e[x][t] = !1),
        n = w(n, {
            enumerable: b(0, !1)
        })) : (r(e, x) || P(e, x, b(1, {})),
        e[x][t] = !0),
      ...
      , q = function(e, t) {
        m(e);
        for (var n, o = _(t = y(t)), r = 0, i = o.length; i > r; )
            K(e, n = o[r++], t[n]);
        return e
    }
      , z = function(e) {
        var t = k.call(this, e = I(e, !0));
        return !(this === B && r(M, e) && !r(G, e)) && (!(t || !r(this, e) || !r(M, e) || r(this, x) && this[x][e]) || t)
    }
      , X = function(e, t) {
        if (e = y(e),
        t = I(t, !0),
        e !== B || !r(M, t) || r(G, t)) {
            var n = E(e, t);
            return !n || !r(M, t) || r(e, x) && e[x][t] || (n.enumerable = !0),
            n
        }
    }
      , Q = function(e) {
        for (var t, n = L(y(e)), o = [], i = 0; n.length > i; )
            r(M, t = n[i++]) || t == x || t == u || o.push(t);
        return o
    }
      , Z = function(e) {
        for (var t, n = e === B, o = L(n ? G : y(e)), i = [], a = 0; o.length > a; )
            !r(M, t = o[a++]) || n && !r(B, t) || i.push(M[t]);
        return i
    };
    F || (s((V = function() {
    ...
    n(21).f = z,
    n(37).f = Z,
    i && !n(20) && s(B, "propertyIsEnumerable", z, !0),
    v.f = function(e) {
        return Y(p(e))
    }
    ),
    ...
    V.prototype[D] || n(14)(V.prototype, D, V.prototype.valueOf),
    f(V, "Symbol"),
    f(Math, "Math", !0),
    f(o.JSON, "JSON", !0)
}
...
, function(e, t, n) {
    "use strict";
    var o, r, i, a, s = n(20), u = n(1), c = n(24), l = n(49), f = n(7), d = n(4), p = n(25), v = n(83), g = n(84), _ = n(88), h = n(50).set, m = n(90)(), O = n(51), y = n(91), I = n(92), b = n(93), w = u.TypeError, A = u.process, T = A && A.versions, S = T && T.v8 || "", C = u.Promise, E = "process" == l(A), P = function() {}, L = r = O.f, V = !!function() {
        try {
            var e = C.resolve(1)
            ...
            ;
            return (E || "function" == typeof PromiseRejectionEvent) && e.then(P)instanceof t && 0 !== S.indexOf("6.6") && -1 === I.indexOf("Chrome/66")
        } catch (e) {}
    }(), N = function(e) {
        var t;
        ...
        if (!e._n) {
            ...
            m(function() {
                for (var o = e._v, r = 1 == e._s, i = 0, a = function(t) {
                    var n, i, a, s = r ? t.ok : t.fail, u = t.resolve, c = t.reject, l = t.domain;
                    try {
                        s ? (r || (2 == e._h && k(e),
                        e._h = 1),
                        !0 === s ? n = o : (l && l.enter(),
                        ...
                        l && (l.exit(),
                        a = !0)),
                        n === t.promise ? c(w("Promise-chain cycle")) : (i = N(n)) ? i.call(n, u, c) : u(n)) : c(o)
                    } catch (e) {
                        l && !a && l.exit(),
                        c(e)
                    }
        ...
        h.call(u, function() {
            ...
            if (i && (t = y(function() {
                E ? A.emit("unhandledRejection", r, e) : (n = u.onunhandledrejection) ? n({
                    promise: e,
                    reason: r
        ...
        h.call(u, function() {
            var t;
            E ? A.emit("rejectionHandled", e) : (t = u.onrejectionhandled) && t({
                promise: e,
                reason: e._v
            })
        })
    ...
    (t = e.exports = function(e, t, n, f, d) {
        ...
        if (i(h)) {
            for (p = s(e.length); p > O; O++)
                if ((_ = t ? m(a(v = e[O])[0], v[1]) : m(e[O])) === c || _ === l)
                    return _
        } else
            for (g = h.call(e); !(v = g.next()).done; )
                if ((_ = r(g, m, v.value, t)) === c || _ === l)
                    return _
    }
    ).BREAK = c,
    t.RETURN = l
...
, function(e, t, n) {
    ...
    Array.from || Math.pow(2, 53);
    var i = n(52).encodeConsentString
      , a = n(55).decodeConsentString
      , s = n(54).vendorVersionMap
      , u = /^[a-z]{2}$/
      , c = function() {
        function e() {
        ...
        return r(e, [{
            ...
            value: function(e) {
                var t = a(e)
                  , n = {};
                return s[t.version].metadataFields.forEach(function(e) {
                    n[e] = t[e]
                }),
                n
            }
...
, function(e, t, n) {
    (function(e, o) {
        ...
        !function(i) {
            var a = ("object" == typeof e && e && e.exports,
            "object" == typeof o && o);
            a.global !== a && a.window;
            var s = function(e) {
                this.message = e
            ...
            var u = function(e) {
              ...
              , f = {
                encode: function(e) {
                    ...
                    n = e.charCodeAt(++s),
                    a += c.charAt((r = t + n) >> 10) + c.charAt(r >> 4 & 63) + c.charAt(r << 2 & 63) + "=") : 1 == i && (r = e.charCodeAt(s),
                    a += c.charAt(r >> 2) + c.charAt(r << 4 & 63) + "=="),
                    a
                },
                decode: function(e) {
...
, function(e, t, n) {
    ...
    t.verifyPowerOptIn = function() {
        return new Promise(function(e) {
            (0,
            i.isPoiActive)() ? f().then(function(t) {
                var n = t.iframe;
                n ? n.onload ? p((0,
                a.getOrigin)()).then(function(t) {
                    t || e({
                        power_opt_in: !1
                    }),
                    e(t)
                ...
                : ((0,
                s.logInfo)("Could not initialize POI. Fallback to POI false."),
                e({
                    power_opt_in: !1
                }))
            }) : e({
    ...
    t.deActivatePowerOptIn = function() {
        return (0,
        s.logInfo)("deActivatePowerOptIn"),
        (0,
        i.isPoiActive)() ? new Promise(function(e) {
    ...
    function l(e) {
        ...
        return t ? (0,
        s.logInfo)("Found iframe") : ((0,
        s.logInfo)("Creating iframe..."),
        (t = document.createElement("iframe")).setAttribute("id", "oil-frame"),
        t.setAttribute("title", "oil-frame"),
        t.setAttribute("aria-hidden", "true"),
        t.setAttribute("src", e),
        t.setAttribute("sandbox", "allow-same-origin allow-scripts allow-forms allow-top-navigation"),
        t.style.width = "0",
        t.style.height = "0",
        t.style.border = "0",
        t.style.border = "none",
            ...
            return setTimeout(function() {
                ...
                i.isPoiActive)()) {
                    ...
                    if (t) {
                        ...
                        (0,
                        s.logError)("Config for " + r.OIL_CONFIG.ATTR_HUB_ORIGIN + " and " + r.OIL_CONFIG.ATTR_HUB_PATH + " isnt set. No POI possible."),
                        e(!1)
                } else
                    (0,
                    s.logInfo)("POI not active. Frame not initialized."),
                    e(!1)
            })
        }
        )
    ...
    function d(e, t) {
        ...
        (0,
        s.logInfo)("Send to Frame:", e, t),
        (0,
        i.isPoiActive)() && f().then(function(o) {
            var r = o.iframe
              , a = (0,
            i.getHubOrigin)()
              , s = (0,
            ...
            if (r && a) {
                ...
                r.contentWindow.postMessage(u, a)
            }
        })
    }
    function p(e) {
        return new Promise(function(t) {
            function n(e) {
                ...
                if (r && -1 !== r.indexOf(e.origin)) {
                    ...
                    (0,
                    s.logInfo)("Message from hub received...", e.origin, u),
                    (0,
                    a.removeMessageListener)(n),
                    c = !1,
                    t(u)
                }
            }
...
, function(e, t, n) {
    ...
    t.manageDomElementActivation = function() {
        for (var e = document.querySelectorAll("[" + o.MANAGED_TAG_IDENTIFIER_ATTRIBUTE + "='" + o.MANAGED_TAG_IDENTIFIER + "']"), t = (0,
        r.getSoiCookie)(), n = 0; n < e.length; n++)
            u(e[n], t)
    }
    ;
    var o = n(13)
    ...
    function u(e, t) {
        "SCRIPT" === e.tagName ? function(e, t) {
            ...
            f(e, t) ? (e.getAttribute("data-type") && (n.type = e.getAttribute("data-type")),
            e.getAttribute("data-src") && (n.src = e.getAttribute("data-src"))) : n.type = o.MANAGED_TAG_IDENTIFIER,
    ...
    function f(e, t) {
        if (t.opt_in) {
            var n = function(e) {
                ...
                a.getPurposeIds)().concat((0,
                s.getCustomPurposeIds)())
            }(e)
              , r = t.consentData.getPurposesAllowed();
            return r = r ? r.concat(t.customPurposes) : t.customPurposes,
            (0,
            i.arrayContainsArray)(r, n)
        }
        return !1
    }
}
...
, function(e, t, n) {
    ...
    t.initOilLayer = function e() {
        if ((0,
        i.logInfo)("Init OilLayer (version " + o.OilVersion.get() + ")"),
        (0,
        c.isPreviewMode)() && !(0,
        s.isPreviewCookieSet)() && (0,
        i.logPreviewInfo)("Preview mode ON and OIL layer remains hidden. Run AS_OIL.previewModeOn() and reload to display the layer."),
        ...
        function() {
            ...
            (0,
            o.setGlobalOilObject)("previewModeOn", function() {
                return (0,
                s.setPreviewCookie)(),
                "preview mode on"
            }),
            (0,
            o.setGlobalOilObject)("previewModeOff", function() {
                return (0,
                s.removePreviewCookie)(),
                "preview mode off"
            }),
            (0,
            o.setGlobalOilObject)("verboseModeOn", function() {
                return (0,
                s.setVerboseCookie)(),
                "verbose mode on"
            }),
            (0,
            o.setGlobalOilObject)("verboseModeOff", function() {
                return (0,
                s.removeVerboseCookie)(),
                "verbose mode off"
            }),
            (0,
            o.setGlobalOilObject)("reload", function() {
                return (0,
            ...
            (0,
            o.setGlobalOilObject)("status", function() {
                return (0,
                s.getSoiCookie)()
            }),
            (0,
            o.setGlobalOilObject)("showPreferenceCenter", function() {
                t(function(e) {
                    e.oilShowPreferenceCenter()
                })
            }),
            (0,
            o.setGlobalOilObject)("triggerOptIn", function() {
                t(function(e) {
                    e.handleOptIn()
                })
            }),
            (0,
            o.setGlobalOilObject)("triggerSoiOptIn", function() {
                t(function(e) {
                    e.handleSoiOptIn()
                })
            }),
            (0,
            o.setGlobalOilObject)("triggerPoiOptIn", function() {
                t(function(e) {
                    e.handlePoiOptIn()
                })
            }),
            (0,
            o.setGlobalOilObject)("triggerOptOut", function() {
                (0,
                r.handleOptOut)()
            }),
            (0,
            o.setGlobalOilObject)("applyGDPR", function() {
                return (0,
                c.setGdprApplies)(!0),
                e(),
                "GDPR applied"
        ...
        !(0,
        c.isPreviewMode)() || (0,
        s.isPreviewCookieSet)()) {
            if (!(0,
            s.isBrowserCookieEnabled)())
                return (0,
                i.logInfo)("This browser doesn't allow cookies."),
                new Promise(function(e) {
                    Promise.all([n.e(1), n.e(0)]).then(function(t) {
                        e(n(103))
                    }
                ...
                void (0,
                o.sendEventToHostSite)(l.EVENT_NAME_NO_COOKIES_ALLOWED);
            (0,
            a.checkOptIn)().then(function(e) {
                e ? ((0,
                o.sendEventToHostSite)(l.EVENT_NAME_HAS_OPTED_IN),
                (0,
    ...
    function p() {
        ...
        (0,
        d.manageDomElementActivation)()
    }
    function v() {
        (0,
        o.setGlobalOilObject)("commandCollectionExecutor", f.executeCommandCollection)
    }
}
, function(e, t, n) {
    "use strict";
    ...
    t.handleOptOut = function() {
        (0,
        r.logInfo)("OptOut Received."),
        (0,
        i.removeSubscriberCookies)(),
        (0,
        o.deActivatePowerOptIn)().then(function() {
            return (0,
            a.sendEventToHostSite)(s.EVENT_NAME_OPT_OUT)
        }),
        (0,
        u.manageDomElementActivation)()
    }
    ;
    var o = n(101)
      , r = n(5)
...
, function(e, t, n) {
    ...
    t.checkOptIn = function() {
        return new Promise(function(e, t) {
            var n = (0,
            a.getSoiCookie)().opt_in
              , s = n;
            (0,
            o.verifyPowerOptIn)().then(function(o) {
                !function(e, t) {
                    o.power_opt_in ? (0,
                    r.logPreviewInfo)("User has given POI permit, OIL not shown.") : e ? (0,
                    r.logPreviewInfo)("User has given SOI permit, OIL not shown.") : (0,
                    r.logPreviewInfo)("User has not opted in at all, OIL should be shown.")
                }(n),
                o.power_opt_in && (s = o.power_opt_in,
                (0,
                i.isSubscriberSetCookieActive)() && !n && (0,
                a.setSoiCookieWithPoiCookieData)(o).then(function() {
                    return e(s)
                }).catch(function(e) {
                    return t(e)
                })),
...
, function(e, t, n) {
    ...
    var i = "_dip_oil_purpose_all"
      ...
      , s = "_dip_oil_purpose_02"
      , u = "_dip_oil_purpose_03"
      , c = "_dip_oil_purpose_04"
      , l = "_dip_oil_purpose_05";
    function f() {
        if (window && window.utag) {
            !function() {
                if (!window.oilEventListenerForLoadingRules) {
                    window.oilEventListenerForLoadingRules = d;
                    var e = window.addEventListener ? "addEventListener" : "attachEvent"
                      , t = "attachEvent" === e ? "onmessage" : "message";
                    (0,
                    window[e])(t, window.oilEventListenerForLoadingRules, !1)
                }
            }(),
            window.utag_data || (window.utag_data = {});
            var e = window.utag_data
              , t = (0,
            o.getSoiCookie)().consentData;
            if (t) {
                var n = t.getPurposesAllowed();
                5 === n.length ? e[i] = 1 : (function(e, t) {
                    e[a] = -1 !== t.indexOf(1) ? 1 : 0,
                    e[s] = -1 !== t.indexOf(2) ? 1 : 0,
                    e[u] = -1 !== t.indexOf(3) ? 1 : 0,
                    e[c] = -1 !== t.indexOf(4) ? 1 : 0,
                    e[l] = -1 !== t.indexOf(5) ? 1 : 0
                }(e, n),
                function(e) {
                    e[i] = 1 === e[a] && 1 === e[s] && 1 === e[u] && 1 === e[c] && 1 === e[l] ? 1 : 0
                }(e))
            } else
                !function(e) {
                    e[i] = 0,
    ...
    function d(e) {
        var t;
        e && e.data && (t = "oil_opt",
        -1 !== JSON.stringify(e.data).indexOf(t)) && (f(),
        function() {
            var e = window.utag_data;
            if (e) {
                var t, n = (r(t = {}, i, e[i]),
...
, function(e, t, n) {
    ...
    var o = n(5)
      ...
      , s = {
        getVendorConsents: function(e) {
            return (0,
            i.getVendorConsentData)(e)
        },
        getConsentData: function(e) {
            return (0,
            i.getConsentDataString)(e)
        },
        getPublisherConsents: function(e) {
            return (0,
            i.getPublisherConsentData)(e)
        },
    ...
    function u(e) {
        (0,
        a.loadVendorList)().then(function() {
            var t, n;
            (t = e.command,
            n = e.parameter,
            new Promise(function(e, r) {
                return "function" == typeof s[t] ? ((0,
                o.logInfo)('Processing command "' + t + '" with parameters "' + n + '"'),
                e(s[t](n))) : r('Invalid CMP command "' + t + '"')
            }
            )).then(function(t) {
                if (e.callback)
                    e.callback(t, void 0 !== t);
                else if (e.callId) {
                    var n = function(e, t) {
                        return {
                            __cmpReturn: {
                    ...
                    (0,
                    o.logError)("Invalid command entry '" + JSON.stringify(e) + "' found!")
            }, function(e) {
                return (0,
                o.logError)(e)
            })
    ...
    t.getVendorConsentData = function(e) {
        ...
        if (t && t.consentData)
            return {
                ...
                r.gdprApplies)(),
                hasGlobalScope: !1,
                purposeConsents: s(t.consentData.getPurposesAllowed(), (0,
                i.getPurposeIds)()),
                vendorConsents: function(e, t) {
                    var n = t && t.length ? t : (0,
                    i.getLimitedVendorIds)()
                      , o = e.consentData.getVendorsAllowed();
                    return n.reduce(function(e, t) {
                        return e[t] = -1 !== o.indexOf(t),
                        e
                    }, {})
                }(t, e)
            }
    ...
    t.getPublisherConsentData = function(e) {
        ...
        if (t && t.consentData && t.customPurposes)
            return {
                ...
                r.gdprApplies)(),
                hasGlobalScope: !1,
                standardPurposeConsents: s(t.consentData.getPurposesAllowed(), (0,
                i.getPurposeIds)(), e),
                customPurposeConsents: s(t.customPurposes, (0,
                r.getCustomPurposeIds)(), e)
            }
    }
    ;
    var o = n(16)
